...
export function LoginModal({
  ...
  const styles = createLoginModalStyles(colors);
    ...
    try {
      ...
      if (
        ...
        const mappedUser = mapApiUserToMultiCompanyUser({
          ...
          ...userData,
          companyIdDefault:
            userData?.companyIdDefault ||
            response.data.user.companyIdDefault ||
            userData?.companyId ||
            response.data.user.companyId ||
            "",
          companies:
            userData?.companies || response.data.user.companies || undefined,
          currentBranchId:
            userData?.currentBranchId ||
            response.data.user.currentBranchId ||
            "",
        ...
        alert.showSuccess(
          response.result?.description || t.api.loginSuccess || "Login exitoso",
        );
        onClose();
        onLoginSuccess?.();
      } else {
