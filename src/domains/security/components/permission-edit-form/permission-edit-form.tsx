...
export function PermissionEditForm({
  ...
  useEffect(() => {
    const loadPermission = async () => {
      ...
      try {
        ...
        const permission =
          await PermissionsService.getPermissionById(permissionId);
        ...
        menuItemIdsValue = menuItemIdsValue.filter(
          (id: any) =>
            id != null &&
            id !== "" &&
            typeof id === "string" &&
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert.showSuccess(
        t.security?.permissions?.edit || "Permiso actualizado exitosamente",
      );
      onSuccess?.();
    } catch (error: any) {
        ...
        <View style={styles.inputGroup}>
          ...
          >
            ...
            <TextInput
              style={[styles.input, { color: colors.text }]}
              placeholder={
                t.security?.permissions?.action ||
                "Acción (ej: view, create, edit, delete)"
              }
              placeholderTextColor={colors.textSecondary}
