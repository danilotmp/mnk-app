 ...
 */
function formatDateForDisplay(isoDate: string | null | undefined, format: string = 'DD/MM/YYYY'): string {
  if (!isoDate) return '';
 ...
 */
function parseDateFromDisplay(displayDate: string, format: string = 'DD/MM/YYYY'): string | null {
  ...
  try {
    ...
    if (date.getDate() !== dayNum || date.getMonth() + 1 !== monthNum || date.getFullYear() !== yearNum) {
      return null;
    }
 ...
 */
function formatInputWhileTyping(text: string, format: string = 'DD/MM/YYYY'): string {
