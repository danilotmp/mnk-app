            ...
            {index > 0 && (
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      (steps[index - 1]?.completed || steps[index - 1]?.completionPercentage === 100)
                        ? '#10b981' // Verde cuando la capa anterior tiene datos
                        : (steps[index - 1]?.skipped && steps[index - 1]?.completionPercentage < 100)
                        ? '#ff6b35' // Tomate cuando la capa anterior está omitida sin datos
            ...
            >
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      (status === 'completed' || step.completed || step.completionPercentage === 100)
                        ? '#10b981' // Verde cuando tiene datos
                        : status === 'skipped'
                        ? '#ff6b35' // Tomate cuando está omitida sin datos
                        : status === 'active'
                        ? colors.primary
                ...
                style={[
                  styles.connectorLineRight,
                  {
                    backgroundColor:
                      (status === 'completed' || step.completed || step.completionPercentage === 100)
                        ? '#10b981' 
                        : colors.borderLight || colors.border, // Usar borderLight para mejor visibilidad en dark theme
                    height: 2,
                  },
                ]}
              />
