...
export interface Translations {
  ...
  pages: {
    ...
    flows: {
      ...
      deleteFlow: string;
      deleteStage: string;
      deleteFlowConfirm: string;
      deleteStageConfirm: string;
      systemFlowNotDeletable: string;
      flowCreated: string;
      flowUpdated: string;
      flowDeleted: string;
      stageCreated: string;
    ...
    chatIa: {
      ...
      emptyNoContactsFound: string;
      emptyNoContactsYet: string;
      tooltipSpecialistRemove: string;
      tooltipSpecialistAdd: string;
      tooltipMarkRead: string;
      tooltipMarkUnread: string;
      tooltipDisableBot: string;
      tooltipEnableBot: string;
      tooltipClientInfo: string;
      tooltipAttach: string;
      confirmRemoveSpecialistTitle: string;
      confirmRemoveSpecialistMessage: string;
      confirmRemoveSpecialistAction: string;
      errorDownloadImage: string;
      errorLoadContacts: string;
      errorLoadMessages: string;
      errorEmptyMessage: string;
      errorEditMessage: string;
      errorDeleteMessage: string;
      errorCopyMessage: string;
      errorUpdateBot: string;
      errorUpdateReadState: string;
      errorUpdateSpecialist: string;
      errorSelectFiles: string;
      errorMaxFiles: string;
      errorTotalSizeExceeded: string;
      errorProcessAttachments: string;
      errorSendEmpty: string;
      errorSendMessage: string;
      errorFileTooLarge: string;
      errorFileInvalidMedia: string;
      errorDocumentPickerMobile: string;
      attachDocument: string;
      attachDocumentSubtitle: string;
      attachPhotosVideos: string;
      attachPhotosVideosSubtitle: string;
      tooltipEmojis: string;
