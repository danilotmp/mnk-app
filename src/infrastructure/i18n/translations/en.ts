...
export const en: Translations = {
  ...
  pages: {
    ...
    chatOrders: {
      ...
      detailSubtitle: "Complete order information",
      detailCreatedAt: "Date",
      detailTotal: "Total",
      sectionClient: "Client Information",
      sectionProduct: "Product Detail",
      sectionBranch: "Branch & Address",
      sectionPayment: "Payment Receipt",
      paymentBank: "Bank",
      paymentSender: "Sender",
      paymentBeneficiary: "Beneficiary",
      paymentSourceAccount: "Source account",
      paymentDestAccount: "Destination account",
      paymentDate: "Date",
      paymentReceipt: "Receipt No.",
      ...
      commentsPlaceholder: "Write a comment about this order...",
    ...
    chatIa: {
      ...
      filterSpecialistA11y: "Filter chats that need specialist assistance",
      loadingContacts: "Loading contacts...",
      emptyNoContactsFound: "No contacts found",
      emptyNoContactsYet: "No contacts yet",
      tooltipSpecialistRemove: "Turn off specialist help",
      tooltipSpecialistAdd: "Turn on specialist help",
      tooltipMarkRead: "Mark as read",
      tooltipMarkUnread: "Mark as unread",
      tooltipDisableBot: "Disable AI chat",
      tooltipEnableBot: "Enable AI chat",
      tooltipClientInfo: "Client information",
      tooltipAttach: "Attach",
      confirmRemoveSpecialistTitle: "Remove assignment",
      confirmRemoveSpecialistMessage:
        "Are you sure? If you have not replied to the user yet, follow-up on this case may be lost.",
      confirmRemoveSpecialistAction: "Remove assignment",
      errorDownloadImage: "Could not download the image",
      errorLoadContacts: "Could not load contacts",
      errorLoadMessages: "Could not load messages",
      errorEmptyMessage: "Message cannot be empty",
      errorEditMessage: "Could not edit message",
      errorDeleteMessage: "Could not delete message",
      errorCopyMessage: "Could not copy message",
      errorUpdateBot: "Could not update bot state",
      errorUpdateReadState: "Could not update read state",
      errorUpdateSpecialist: "Could not update specialist assignment",
      errorSelectFiles: "Could not select files",
      errorMaxFiles: "Maximum {max} files per message",
      errorTotalSizeExceeded:
        "Total file size ({sizeMB}MB) exceeds the 50MB limit",
      ...
      attachDocumentSubtitle: "All files",
      attachPhotosVideos: "Photos & videos",
      attachPhotosVideosSubtitle: "Media files",
      tooltipEmojis: "Emoji",
      tooltipQuickMessages: "Quick messages",
      tooltipDownloadImage: "Download image",
      ...
      whatsappChannelDeactivateConfirmTitle: "Deactivate channel?",
      whatsappChannelDeactivateConfirmMessage:
        "This channel will be turned off and will stop replying automatically on WhatsApp.",
      whatsappChannelDeactivateConfirmButton: "Deactivate",
      whatsappChannelToggleSuccessActive: "Channel activated successfully",
      whatsappChannelToggleSuccessInactive: "Channel deactivated successfully",
      whatsappChannelToggleError: "Could not update channel status",
      whatsappChannelToggleMissingInstanceId:
        "Could not identify the instance. Reload the screen or use Commercial setup.",
    },
    flows: {
      title: "Configurable Flows",
      subtitle: "Manage conversational flow templates and their stages",
      newFlow: "New Flow",
      createFlow: "Create Flow",
      editFlow: "Edit Flow",
      createSubtitle: "Define a new flow template",
      editSubtitle: "Update flow details",
      code: "Code",
      name: "Name",
      ...
      stagesSubtitle: "Reorder the flow stages",
      newStage: "New Stage",
      ...
      deleteFlowConfirm: "Are you sure you want to delete this flow?",
      deleteStageConfirm: "Are you sure you want to delete this stage?",
      systemFlowNotDeletable: "System flows cannot be deleted",
      ...
      noStages: "No stages configured. Add one to get started.",
      noFlows: "No flows configured",
      tipTitle: "Flow Tips",
      tipMessage: "Stages should be sequential. Avoid creating more than 7 to maintain operational clarity.",
      filterPlaceholder: "Filter by code or name...",
      searchPlaceholder: "Search templates...",
    },
    behaviors: {
      title: "Behaviors",
      subtitle: "Catalog of actions the chatbot executes at each stage",
      ...
      skipAgent: "Skip AI agent",
      skipAgentDescription: "Direct response without going through AI",
      ...
      noGuidelines: "No guidelines configured",
      skipConditions: "Skip conditions",
      stageConfig: "Technical configuration",
      formatJson: "FORMAT JSON",
      status: "Status",
      isSystem: "System",
      behaviorUpdated: "Behavior updated successfully",
      filterPlaceholder: "Filter by key or name...",
      noData: "No behaviors configured",
    },
    capabilities: {
  ...
  wizard: {
    ...
    layers: {
      ...
      recommendations: {
        ...
        sectionTitleConfigured: "Configured Recommendations",
        recommendationTypeLabel: "Recommendation type",
        offersLabel: "Offerings",
        selectOfferPlaceholder: "Select an offering",
        offerSelectorCaption:
          "Select an offering for a specific recommendation.",
        messageLabel: "Recommendation message *",
        messagePlaceholder: "Describe the recommendation message...",
        orderLabel: "Order",
        orderHint: "Lower number = higher priority (default: 0)",
        ...
        skip: "Skip",
        accept: "Accept",
        warningGeneral: "General Warning",
        statusActive: "Active",
      ...
      whatsappConnection: {
        ...
        columnMonthTransactions: "Transactions",
        columnMonthDocuments: "Documents",
        columnMonthOperations: "Orders",
        columnMonthPayments: "Payments",
        ...
        errorDownloadingFlow: "Error downloading flow",
        flowLabel: "Flow",
        ...
        reconnectConfirmTitle: "Reconnect",
        reconnectConfirmMessage:
          "A new connection instance will be created and currently connected devices will be disconnected.\n\nTo reconnect them you must scan the new QR code.\n\nDo you want to continue?",
        reconnectSuccess: "Reconnection successful. Scan the new QR code.",
        errorReconnecting: "Error reconnecting instance",
  ...
  promotions: {
    titleGeneral: "General promotions",
    titleSpecific: "Offering promotions",
    subtitleGeneral: "Promotions that apply to all offerings",
    subtitleSpecific: "Specific promotions for this offering",
    empty: "No promotions registered",
    ...
    deleteMessage: "Are you sure you want to delete this promotion?",
    created: "Promotion created",
    updated: "Promotion updated",
    deleted: "Promotion deleted",
    errorCreate: "Error creating promotion",
    errorUpdate: "Error updating promotion",
    errorDelete: "Error deleting promotion",
  ...
  conditions: {
    titleGeneral: "General conditions",
    titleOffering: "Offering conditions",
    subtitleGeneral: "Conditions that apply to all offerings",
    subtitleOffering: "Associate conditions to this offering",
    ...
    deleteMessage: "Are you sure you want to delete this condition?",
    created: "Condition created",
    updated: "Condition updated",
    deleted: "Condition deleted",
    errorCreate: "Error creating condition",
    errorUpdate: "Error updating condition",
    errorDelete: "Error deleting condition",
    conditionsButton: "Conditions",
