...
export const en: Translations = {
  ...
  security: {
    ...
    permissions: {
      ...
      selectMenuItemsSubtitle: 'Select the menu items to which this permission will be associated',
    ...
    companies: {
      ...
      deleteConfirmMessage: 'Are you sure you want to delete the company {name}? This action cannot be undone.',
    ...
    menuAdmin: {
      ...
      deleteGroupingMessage: 'Are you sure you want to delete this grouping? Items will be moved to the parent submenu.',
