...
export const es: Translations = {
  ...
  pages: {
    ...
    chatOrders: {
      ...
      subtitle: "Órdenes generadas por Chat IA",
      kpiTotalOrders: "Total Órdenes",
      kpiTotalAmount: "Monto Total",
      searchPlaceholder: "Buscar órdenes...",
      loading: "Cargando órdenes...",
      emptyMessage: "No hay órdenes para mostrar",
      emptyNoCompany: "Selecciona una empresa para ver las órdenes",
      ...
      detailSubtitle: "Información completa de la orden",
      detailCreatedAt: "Fecha de ingreso",
      detailTotal: "Total",
      sectionClient: "Datos del Cliente",
      sectionProduct: "Detalle del Producto",
      sectionBranch: "Sucursal y Dirección",
      sectionPayment: "Comprobante de Pago",
      paymentBank: "Banco",
      paymentSender: "Ordenante",
      paymentBeneficiary: "Beneficiario",
      paymentSourceAccount: "Cuenta origen",
      paymentDestAccount: "Cuenta destino",
      paymentDate: "Fecha",
      paymentReceipt: "N.º comprobante",
      ...
      reviewedAtLabel: "Fecha de revisión",
      ...
      commentsPlaceholder: "Escribe un comentario sobre esta orden...",
      saveReview: "Guardar revisión",
      saving: "Guardando...",
      reviewSaved: "Revisión guardada correctamente",
      reviewSaveError: "Error al guardar la revisión",
  ...
  promotions: {
    titleGeneral: "Promociones generales",
    titleSpecific: "Promociones de la oferta",
    subtitleGeneral: "Promociones que aplican a todas las ofertas",
    subtitleSpecific: "Promociones específicas de esta oferta",
    empty: "Sin promociones registradas",
    ...
    deleteMessage: "¿Seguro que deseas eliminar esta promoción?",
    created: "Promoción creada",
    updated: "Promoción actualizada",
    deleted: "Promoción eliminada",
    errorCreate: "Error al crear la promoción",
    errorUpdate: "Error al actualizar la promoción",
    errorDelete: "Error al eliminar la promoción",
    promotionsButton: "Promociones",
    nameLabel: "Nombre",
    descLabel: "Descripción",
  },

  conditions: {
    titleGeneral: "Condiciones generales",
    titleOffering: "Condiciones de la oferta",
    subtitleGeneral: "Condiciones que aplican a todas las ofertas",
    subtitleOffering: "Asocia condiciones a esta oferta",
    ...
    deleteMessage: "¿Seguro que deseas eliminar esta condición?",
    created: "Condición creada",
    updated: "Condición actualizada",
    deleted: "Condición eliminada",
    errorCreate: "Error al crear la condición",
    errorUpdate: "Error al actualizar la condición",
    errorDelete: "Error al eliminar la condición",
    conditionsButton: "Condiciones",
