...
export const es: Translations = {
  ...
  security: {
    ...
    permissions: {
      ...
      selectMenuItemsSubtitle: 'Selecciona los items del menú a los que se asociará este permiso',
    ...
    companies: {
      ...
      deleteConfirmMessage: '¿Seguro que deseas eliminar la empresa {name}? Esta acción no se puede deshacer.',
    ...
    menuAdmin: {
      ...
      deleteGroupingMessage: '¿Está seguro de eliminar este agrupamiento? Los items se moverán al submenu del padre.',
      groupingDeleted: 'Agrupamiento eliminado. Los items se movieron al submenu.',
      itemsMovedToSubmenu: 'Agrupamiento eliminado. Los items se movieron al submenu.',
